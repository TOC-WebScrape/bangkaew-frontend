  ...
  return (
    ...
    <body>
      ...
      <div className='boxArea'>
        ...
        <text className='BangkaewText'>Welcome to bangkaew</text>
        <div className='spinner-box'>
          <div className='configBorder1'>
            <div className='configCore'></div>
          </div>
        ...
        <div className="Boxcard">
          ...
          <div className="right">
            <div className="words">
              ...
              <a href="https://www.investopedia.com/terms/c/cryptocurrency.asp" className="btn" target='_blank'rel='noopener noreferrer'>Read more</a>
            </div>
          </div>
        </div>
        ...
        <div className="Boxcard">
          ...
          <div className="right">
            <div className="words">
              ...
              <a href="https://www.benzinga.com/how-to-trade-cryptocurrency" className="btn" target='_blank'rel='noopener noreferrer'>Read more</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="footer">
        <div className="btnFont">
          <a href="https://github.com/TOC-WebScrape/bangkaew-frontend" target='_blank'rel='noopener noreferrer'><span>Frontend Github</span></a>
        </div>
        <div className="footerContent">
          <h3>BANGKAEW GITHUB</h3>
          <p>In this TOC's subject project.We are doing 'web scrapping' and we divided into 2 team. Frontend and Backend.
            You can visit our github's project instead. Enjoy.
          </p>
        </div>
        <div className="btnBack">
          <a href="https://github.com/TOC-WebScrape/bangkaew-backend" target='_blank'rel='noopener noreferrer'><span>Backend Github</span></a>
        </div>
      </div>
